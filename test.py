...
try:
    ...
    print(f"💥 필수 모듈 임포트 실패: {e}"); sys.exit(1)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--deg_vae_path", type=str, default = 'checkpoints/DEGMON_AE_Best_model_state_dict_20251209_200711.pth')
    ...
    parser.add_argument("--max_eval_samples", type=int, default=None, help="평가에 사용할 최대 샘플 수 (None=전체)")
    parser.add_argument("--eval_chunk_size", type=int, default=10000, help="평가 시 청크 크기")
